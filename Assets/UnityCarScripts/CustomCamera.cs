...
public class CustomCamera : MonoBehaviour {
	public enum CameraType {SmoothLookAt,MouseOrbit,FixedTo,Map};
	public CameraType mycamera;
	...
	void LateUpdate () {
		if (target){
			if (mycamera==CameraType.MouseOrbit){ // mouse orbit
			...
			else if (mycamera==CameraType.Map){ //Map Camera
			...
			else if (mycamera==CameraType.SmoothLookAt){ //SmoothLookAt
			...
			else if (mycamera==CameraType.FixedTo){ //FixedTo
